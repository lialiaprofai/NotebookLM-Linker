...
def ask_question(topic_slug: str, topic_name: str, question: str, chat_history: List[Dict[str, str]] = None, gemini_api_key: str = None) -> str:
    """
...
def chat_pre_search(topic: str, chat_history: List[Dict[str, str]], question: str, gemini_api_key: str = None) -> str:
    """
    ...
    5. Напомните пользователю, что когда обсуждение направлений поиска завершено, он должен нажать кнопку «Сгенерировать план» (Generate Plan) на панели управления для перехода к списку источников.
